...
LowLevelFFT::LowLevelFFT()
{

}

void LowLevelFFT::cdft(int n, int isgn, double *a)
{
	if (isgn >= 0) {
		cftfsub(n, a);
	} else {
...
void LowLevelFFT::rdft(int n, int isgn, double *a)
{
	double xi;
...
void LowLevelFFT::ddct(int n, int isgn, double *a)
{
	int j;
	double xr;
...
void LowLevelFFT::ddst(int n, int isgn, double *a)
{
	int j;
	double xr;
...
void LowLevelFFT::dfct(int n, double *a)
{
	int j, k, m, mh;
...
void LowLevelFFT::dfst(int n, double *a)
{
	int j, k, m, mh;
	double xr, xi, yr, yi;
...
void LowLevelFFT::cftfsub(int n, double *a)
{
	if (n > 8) {
		if (n > 32) {
			cftmdl1(n, a);
...
void LowLevelFFT::cftbsub(int n, double *a)
{
	if (n > 8) {
		if (n > 32) {
			cftb1st(n, a);
...
void LowLevelFFT::bitrv2(int n, double *a)
{
...
void LowLevelFFT::bitrv2conj(int n, double *a)
{
	int j0, k0, j1, k1, l, m, i, j, k, nh;
	double xr, xi, yr, yi;
...
void LowLevelFFT::bitrv216(double *a)
{
...
void LowLevelFFT::bitrv216neg(double *a)
{
	double x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i, 
...
void LowLevelFFT::bitrv208(double *a)
{
...
void LowLevelFFT::bitrv208neg(double *a)
{
	double x1r, x1i, x2r, x2i, x3r, x3i, x4r, x4i, 
...
void LowLevelFFT::bitrv1(int n, double *a)
{
	int j0, k0, j1, k1, l, m, i, j, k, nh;
	double x;
...
void LowLevelFFT::cftb1st(int n, double *a)
{
	...
	for (;;) {
		...
		wd1r = cos((double)(ew * i0));
		wd1i = sin((double)(ew * i0));
		wd3i = 4 * wd1i * wd1r;
		wd3r = wd1r - wd3i * wd1i;
		wd3i = wd1i - wd3i * wd1r;
...
void LowLevelFFT::cftrec4_th(int n, double *a)
{
...
void* LowLevelFFT::cftrec1_th(void *p)
{
...
void* LowLevelFFT::cftrec2_th(void *p)
{
	int isplt, j, k, m, n, n0;
	double *a;
...
#endif /* USE_CDFT_THREADS */
void LowLevelFFT::cftrec4(int n, double *a)
{
	int isplt, j, k, m;
...
int LowLevelFFT::cfttree(int n, int j, int k, double *a)
{
	int i, isplt, m;
...
void LowLevelFFT::cftleaf(int n, int isplt, double *a)
{
	if (n == 512) {
		cftmdl1(128, a);
		cftf161(a);
...
void LowLevelFFT::cftmdl1(int n, double *a)
{
	int i, i0, j, j0, j1, j2, j3, m, mh;
	double ew, w1r, w1i, wk1r, wk1i, wk3r, wk3i, 
		wd1r, wd1i, wd3r, wd3i, ss1, ss3;
...
void LowLevelFFT::cftmdl2(int n, double *a)
{
	int i, i0, j, j0, j1, j2, j3, m, mh;
	...
	for (;;) {
		...
		wl1r = cos((double)(ew * i0));
		wl1i = sin((double)(ew * i0));
		wl3i = 4 * wl1i * wl1r;
		wl3r = wl1r - wl3i * wl1i;
		wl3i = wl1i - wl3i * wl1r;
		we1r = wn4r * (wl1r - wl1i);
...
void LowLevelFFT::cftfx41(int n, double *a)
{
	if (n == 128) {
		cftf161(a);
		cftf162(&a[32]);
...
void LowLevelFFT::cftf161(double *a)
{
...
void LowLevelFFT::cftf162(double *a)
{
...
void LowLevelFFT::cftf081(double *a)
{
...
void LowLevelFFT::cftf082(double *a)
{
...
void LowLevelFFT::cftf040(double *a)
{
	double x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i;
...
void LowLevelFFT::cftb040(double *a)
{
	double x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i;
...
void LowLevelFFT::cftx020(double *a)
{
	double x0r, x0i;
...
void LowLevelFFT::rftfsub(int n, double *a)
{
	int i, i0, j, k;
	...
	for (;;) {
		...
		wkr = 0.5 * sin((double)(ec * i0));
		wki = 0.5 * cos((double)(ec * i0));
...
void LowLevelFFT::rftbsub(int n, double *a)
{
	int i, i0, j, k;
	double ec, w1r, w1i, wkr, wki, wdr, wdi, ss, xr, xi, yr, yi;
...
void LowLevelFFT::dctsub(int n, double *a)
{
	int i, i0, j, k, m;
	double ec, w1r, w1i, wkr, wki, wdr, wdi, ss, xr, xi, yr, yi;
	...
	for (;;) {
		...
		wdr = cos((double)(ec * i0));
		wdi = sin((double)(ec * i0));
		wkr = 0.5 * (wdr - wdi);
		wki = 0.5 * (wdr + wdi);
		wdr = wkr * w1r - wki * w1i;
		wdi = wkr * w1i + wki * w1r;
...
void LowLevelFFT::dstsub(int n, double *a)
{
	int i, i0, j, k, m;
	double ec, w1r, w1i, wkr, wki, wdr, wdi, ss, xr, xi, yr, yi;
...
void LowLevelFFT::dctsub4(int n, double *a)
{
	int m;
...
void LowLevelFFT::dstsub4(int n, double *a)
{
	int m;
	double wki, wdr, wdi, xr;
